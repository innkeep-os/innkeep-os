...
## Steps
1. Resolve the target: a project name → `projects/<name>/`; "ideas" → `ideas/`; "notes" → `notes/`; "the list" → `loops.md`; otherwise treat as a path. Read everything in it.
...
5. Sweep: update CLAUDE.md and any other live references if the shape changed.
